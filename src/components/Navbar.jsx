  ...
  return (
    <nav className="fixed w-full z-50 top-0 bg-white bg-opacity-90 backdrop-blur-sm shadow-sm py-4 px-4 sm:px-8 lg:px-16 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center space-x-8">
        ...
        <a href="#pricing" className="hover:text-teal-600 transition">About Us</a>
        <a href="#contact" className="hover:text-teal-600 transition">Contact</a>
      </div>

      {/* CTA Buttons */}
      <div className="hidden lg:flex items-center space-x-4">
        <a href="#" className="px-6 py-2 rounded-full text-teal-600 hover:bg-teal-50 font-semibold">Log In</a>
        <a href="#" className="px-6 py-2 rounded-full text-white bg-teal-500 hover:bg-teal-600 font-semibold">Get Started</a>
      </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-white z-40 flex flex-col items-center justify-center space-y-8 lg:hidden">
          ...
          <div className="flex flex-col space-y-4 pt-8 w-64">
            <a href="#" className="w-full text-center px-6 py-3 rounded-full text-teal-600 border border-teal-600 font-semibold">Log In</a>
            <a href="#" className="w-full text-center px-6 py-3 rounded-full text-white bg-teal-500 hover:bg-teal-600 font-semibold">Get Started</a>
          </div>
        </div>
      )}
    </nav>
